...
class KRAckAttack():
	...
	def run(self, strict_echo_test=False):
		...
		self.hostapd_ctrl = Ctrl("krackattacks-poc-zerokey/krackattack/hostapd_ctrl/" + self.nic_rogue_ap)
		self.hostapd_ctrl.attach()
	
		# Restore internet connection if rogue hostapd fails to initialize		
